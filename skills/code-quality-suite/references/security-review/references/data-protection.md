...
# SAFE: Collect only what is needed
user_data = {
    'name': form.name,
    'email': form.email,
}
...
def secure_zero(data):
    ...
    if isinstance(data, bytearray):
        ...
        # Cannot modify bytes, but can overwrite the reference
        pass
...
# SAFE: Do not cache sensitive data
def get_user_with_ssn(user_id):
...
- [ ] Server headers do not reveal technology stack
