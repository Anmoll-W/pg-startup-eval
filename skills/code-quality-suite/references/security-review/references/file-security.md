...
# Results in: /uploads/../../../etc/passwd resolves to /etc/passwd
```
...
def secure_upload(file):
    ...
    # 3. Validate MIME type (do not trust Content-Type header)
...
def safe_extract(zip_path, extract_dir):
    ...
    with zipfile.ZipFile(zip_path, 'r') as zf:
        for member in zf.namelist():
            ...
            # Verify it is under extract directory
...
- [ ] Filenames sanitized (do not use user input directly)
