...
- **Indirect (cross-side)**: Two distinct user groups benefit from each other's participation. Marketplaces, platforms. The flywheel runs: more buyers, then more sellers, then better prices and selection, then more buyers again.
- **Data network effects**: More users generate more data, which trains a better model, which makes a better product, which brings more users. This is *not* automatic, it requires the feedback loop to actually improve the product for users. Many companies claim this but the loop is too slow or too noisy to matter.

**Local vs. global**: A network effect can be local (within a city, industry, or team) but not global (adding users in Tokyo does not help users in Toronto). Local network effects are real but less defensible than global ones.
...
Your business model is structurally incompatible with the incumbent's P&L, so they cannot copy you without destroying their core business. This is the most underrated and underused moat at early stage.

**The canonical example**: Netflix vs. Blockbuster. Netflix's unlimited streaming subscription required eliminating late fees, but late fees were ~70% of Blockbuster's store revenue. Blockbuster could not replicate Netflix's model without committing financial suicide.
...
**How to identify it**: Ask "What would it cost the market leader to build exactly what we are building?" If the answer is "it would destroy their existing revenue/margins/relationships," you have counter-positioning.

**Early-stage application**: Is there a structural reason the incumbent cannot or will not copy you? Not because they are slow or lazy, but because doing so would harm their core business?
...
**Not applicable at early stage.** Takes 7-10 years of consistent positioning to build. Do not evaluate early-stage ideas on branding potential.
...
**Not applicable at most early-stage evaluations**: process power is built, not designed. It accumulates through years of iteration, failure, and refinement. You cannot have it on day one.
...
- "By then, we will have 200K users and a data flywheel producing training data they cannot replicate" (data network effect)
- "Our customers will have built workflows around us; switching requires 3 months of retraining" (switching costs)
- "The incumbent cannot copy our pricing model without cannibalizing their existing contracts" (counter-positioning)
- "We will hold exclusive data agreements with the top 10 hospitals in the category" (cornered resource)

---

## Thiel's Monopoly Framework

A business worth building aims to monopolize a specific small market, then expand. The moat is not about defending against all competitors, it is about achieving a position where competing in your specific niche becomes economically irrational for others.
...
a16z consistently invests based on counter-positioning theses. Their question: "Why cannot the market leader do this?"

The answer must be **structural**, not executional:
- "They are slower": not structural (they can hire or acquire)
- "They do not care about this segment": slightly structural (requires deliberate neglect)
