...
**What it tells you**: They have a real problem, they believe you can solve it, and they're putting their money or professional reputation behind that belief. This is validation.
...
5. Only then build automation for what you've proven works manually
...
**The rule (Ries)**: If a metric can increase while the business is getting worse, it's a vanity metric.
...
Product-Market Fit is not a feeling. It's observable:
...
- Low NPS with users who aren't enthusiastic advocates
- Every new customer requires significant founder involvement

The moment you genuinely have PMF, you'll know it. Most "we have PMF" claims are premature.
